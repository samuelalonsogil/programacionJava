...
import BoletinPoo.Ejercicios.Discos.Disco;
...
public class ejercicio5 {
    ...
    /**
     * 5. Realiza de nuevo el ejercicio de la colección de discos pero utilizando
     * esta vez una lista para almacenar la información sobre los discos en lugar de
     * un array convencional. Comprobarás que el código se simplifica notablemente
    ...
    public static void main(String[] args) {
        ...
        //este array dinamico mantiene la coleccion
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    if (!album.contains(new Disco(codigoIntroducido, "", "", "", 0))) {
                        ...
                        //SE DEBERIA HACER UNA DOBLE COMPROBACION

                        /*1 mostrar la info del disco
                         * 2. preguntar si borramos
                         */
                        int j =0;
                        j=album.indexOf(new Disco(codigoIntroducido, "", "", "", 0));
                        System.out.println(album.get(j));
                        //2. preguntar si borramos
